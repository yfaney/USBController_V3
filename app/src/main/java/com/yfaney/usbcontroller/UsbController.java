 ...
 * Edited by Faney(Younghwan Jang)
 *
 */
public class UsbController {
    ...
    private final static int VID_FTDI = 0x0403;
	private final int VID;
	private final int PID;
	protected static final String ACTION_USB_PERMISSION = "com.yfaney.android.USB";
	...
	private void enumerate(IPermissionListener listener) {
        ...
        //Toast.makeText(mApplicationContext, "No device found", Toast.LENGTH_SHORT).show();
	...
	private class UsbRunnable implements Runnable {
		...
		public void run() {//here the main USB functionality is implemented
			...
			for (;;) {// this is the main loop for transferring
				...
				int sent = conn.bulkTransfer(epOUT, mData, 1, 0);
                l(Integer.toString(sent) + "bytes sent : " + mData[0]);
